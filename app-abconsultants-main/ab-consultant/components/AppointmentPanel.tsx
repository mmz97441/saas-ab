          ...
          <div className="flex-1">
            ...
            <div className="mt-3 grid grid-cols-2 gap-3">
              <div className="bg-white/60 rounded-lg p-3">
                <p className="text-xs font-bold text-amber-600 uppercase mb-1">Date actuelle</p>
              ...
              <div className="bg-white/60 rounded-lg p-3 border-2 border-amber-300">
                <p className="text-xs font-bold text-amber-600 uppercase mb-1">Date proposée</p>
