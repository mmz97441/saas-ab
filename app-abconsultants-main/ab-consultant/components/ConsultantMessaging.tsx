                ...
                {selectedClientId ? (
                    <>
                        <div className="p-4 border-b border-slate-200 flex justify-between items-center bg-slate-50/50">
                            ...
                            <span className="text-xs bg-brand-100 text-brand-700 px-2 py-1 rounded font-bold">Mode Expert (Historique Complet)</span>
                        </div>
                            ...
                            {messages.map((msg) => (
                                <div key={msg.id} className={`flex flex-col ${msg.sender === 'user' ? 'items-end' : 'items-start'}`}>
                                    ...
                                    {msg.isSystemSummary ? (
                                        ...
                                        <div className={`max-w-[80%] p-4 rounded-xl text-sm shadow-sm ${
                                            msg.sender === 'user' 
                        ...
                        <div className="p-4 border-t border-slate-200 bg-white">
                            <div className="flex gap-2">
                                <input 
                                    ...
                                    className="flex-1 border border-slate-300 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-brand-500"
                                />
                                <button onClick={handleSendReply} className="px-6 bg-brand-600 text-white rounded-lg hover:bg-brand-700 transition shadow-sm font-bold">
